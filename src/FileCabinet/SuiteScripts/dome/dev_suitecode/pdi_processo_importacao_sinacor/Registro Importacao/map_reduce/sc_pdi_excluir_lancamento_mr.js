...
define([
    ...
    (runtime, record, utilsMd, cts ) => {
        ...
        const getInputData = (inputContext) => {
            ...
            const requestBody = runtime.getCurrentScript().getParameter({name: "custscript_sc_pdi_delete_param"});
            ...
            try {
                ...
                return utilsMd.getJournalTransactionsList(requestBody);
        ...
        const map = (mapContext) => {
            ...
            try {
                ...
                const transactionId = mapContext.value;
        ...
        const summarize = (summaryContext) => {
            ...
            try {
                ...
                const {previewStatus} = utilsMd.getImportRecordStatus(requestBody);
